package com.example.gpt.chatGPT;
...
public class ChatGPTService {
    private OpenAiService openAiService = new OpenAiService("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", Duration.ofSeconds(60));
